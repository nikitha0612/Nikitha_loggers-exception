...
public class calculate {
	...
	public static void main(String[] args) {
		...
		float time = sc.nextFloat();
			...
			switch(choice) {
				case 1:
					System.out.println("Simple Interest : "+i.simple_interest(principal, time, rateOfInterest));
				    break;
					
				case 2:
					System.out.println("Enter number of times to be compounded");
					int num = sc.nextInt();
					System.out.println("Compound Interest : "+i.compound_interest(principal, time, rateOfInterest, choice));
					break;
				default:
